...
## 4. 交付物与存放位置
- **艺术风格说明书 (Markdown)**: `[project]/assets/03-art-style/style_guide.md`
- **风格参考图 (Total Map)**: `[project]/assets/03-art-style/style_reference.png`
- **细节参考图 (Detail Maps)**: `[project]/assets/03-art-style/details/[feature].png`
- **参考资料**: `[project]/assets/03-art-style/references/`
...
## 6. 约束与规范
- 交付物必须严格存放在 `[project]/assets/03-art-style/` 目录下。
